...
class CorrelationAgent(BaseAgent):
    ...
    def resolve_entities(self, entities: List[Dict[str, Any]]) -> List[EntityNode]:
        ...
        for e in entities:
            ...
            if val in resolved:
                ...
                resolved[val] = EntityNode(
                    id=e.get("id", f"ent_{len(resolved)}"),
    ...
    async def _execute(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for interaction in raw_interactions:
            ...
            if source and target and evidence:
                edges.append(EvidenceEdge(
                    source_id=source,
                    target_id=target,
                    relationship=interaction.get("type", "communicated_with"),
        ...
        return {
            "resolved_entities": [n.model_dump() for n in resolved_nodes],
