...
import pytest
from mnemosyne.memory.retrieval import HybridRetriever
...
def test_report_generator_validation():
    ...
    valid_data = {
        ...
        "summary": "Test",
        "timeline": [{"time": "12:00", "description": "Event A", "source": "Log", "citation_id": "c1"}],
        "citations": [{"id": "c1", "file_path": "/var/log/syslog", "node_uuid": "1234"}],
    }
    ...
    invalid_data = {
        "timestamp": "2023-01-01",
        "summary": "Test",
        "timeline": [{"time": "12:00", "description": "Event A", "source": "Log", "citation_id": "missing_c2"}],
        "citations": [{"id": "c1", "file_path": "/var/log/syslog", "node_uuid": "1234"}],
    }
