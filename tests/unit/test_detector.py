...
@pytest.mark.asyncio
async def test_detect_pdf() -> None:
    mime = await detect_file_type(str(FIXTURES_DIR / "sample.pdf"))
    assert mime == "application/pdf"


@pytest.mark.asyncio
async def test_detect_docx() -> None:
...
@pytest.mark.asyncio
async def test_empty_file(tmp_path) -> None:
